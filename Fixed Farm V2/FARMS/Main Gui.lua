...
WorldTitle.Text = "Fixed Farm V2.0"
...
local Worlds = {
    ...
    {Name = "Xmas", Desc = "Frozen Aybss farming", Tag = "Holiday", BorderColor = Color3.fromRGB(198,225,215), ID = 2}, -- white
...
--[[
    {Name = "5", Desc = "A farm that prioritizes safety", Tag = "Safe", BorderColor = Color3.fromRGB(255, 0, 0), ID = 5}, -- Red
    {Name = "6", Desc = "An automated farming method", Tag = "Passive", BorderColor = Color3.fromRGB(255, 215, 0), ID = 6}, -- Gold
...
if not isLocked then
    ClickButton.MouseButton1Click:Connect(function()
        ...
        task.spawn(function()
            loadstring(game:HttpGet("https://pastebin.com/raw/k7h5sg7C"))()
        end)
        ...
        task.spawn(function()
            ...
            elseif world.Name == "Infinity Castle" then
                loadstring(game:HttpGet("https://pastebin.com/raw/KR61pACq"))()
            end
        end)
     end)
    end
